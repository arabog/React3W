...
The Problem
State should be held by the highest parent component in the stack 
...
Even though components 2-4 did not need the state, they had 
to pass the state along so that it could reach component 5.
...
In order to use the Context in a child component, we need to access 
